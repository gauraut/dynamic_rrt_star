    ...
    while(!robot->robotAtGoal()){
        ...
        if(obsBlock){
            ...
            if(nextIndx!=(currIndx-1)){
                std::cout<<"Start replanning"<<std::endl;
            ...
            //cv::waitKey(10);
            std::cout<<"Replanning completed"<<std::endl;
...
int main() {
    ...
    DynamObstacle* d1 = new DynamObstacle(6, false, 35 , 20, 3, 55, 45,50);
    DynamObstacle* d2 = new DynamObstacle(6, false, 65 , 30, 3, 50, 35,50);
    DynamObstacle* d3 = new DynamObstacle(7, false, 60,60,3,45, 50, 50);
    DynamObstacle* d4 = new DynamObstacle(7, false, 60,60, 3, 35,35, 50);
    DynamObstacle* d5 = new DynamObstacle(7, false, 40,40,3,40, 60, 50);

    space->addDynamicObstacle(d1);
    space->addDynamicObstacle(d2);
    space->addDynamicObstacle(d3);
    space->addDynamicObstacle(d4);
    space->addDynamicObstacle(d5);
